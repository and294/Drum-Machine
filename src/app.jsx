...
class DrumPad extends React.Component {
  ...
  handleKeydown = (e) => {
    if (
      ...
      e.keyCode === this.props.letter.charCodeAt()
    ) {
      this.audio.play();
...
class App extends React.Component {
  ...
  handleBank = (e) => {
    if (this.state.power == true) {
      if (e.target.value == 0) {
        this.setState({ bank: data2, bankId: "piano", display: "Bank 2" });
      } else if (e.target.value == 1) {
        this.setState({ bank: data, bankId: "drum", display: "Bank 1" });
      }
    }
  };
    ...
    return (
      <div id="drum-machine">
        <div className="top">
          ...
          <div className="p">
            <div className="power" onClick={this.handlePower}>
              <i class="fas fa-power-off"></i>
            </div>
            <div
              className="powerIndic"
              style={
                this.state.power == true ? { backgroundColor: "#ff0000" } : {}
              }
            ></div>
          </div>
        </div>
